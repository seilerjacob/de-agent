/*
    ...
    Materialized as a view: zero storage cost, always reflects current
    unified_customers data (itself a Dynamic Table). Escalate to a
    Dynamic Table if query performance or freshness becomes a concern.
*/
