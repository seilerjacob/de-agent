{#
    ...
    This lands the medallion layers in clean, predictable schemas —
    staging, intermediate, and marts — alongside the raw schema that the
    Python ingestion layer writes to. Without this override, models would
    land in main_staging / main_intermediate, which the pipeline summary
    step would then have to special-case.
